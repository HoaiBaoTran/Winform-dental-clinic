...
{
    partial class AssisstantDescriptionDetail
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AssisstantDescriptionDetail));
            btnBack = new Button();
            btnCreateAss = new Button();
            label1 = new Label();
            ...
            btnBack.Location = new Point(1151, 16);
            btnBack.Margin = new Padding(3, 4, 3, 4);
            btnBack.Name = "btnBack";
            btnBack.Size = new Size(138, 54);
            btnBack.TabIndex = 30;
            ...
            // btnCreateAss
            // 
            btnCreateAss.Anchor = AnchorStyles.Top | AnchorStyles.Right;
            btnCreateAss.Enabled = false;
            btnCreateAss.Font = new Font("Segoe UI", 16.2F, FontStyle.Regular, GraphicsUnit.Point, 0);
            btnCreateAss.Image = (Image)resources.GetObject("btnCreateAss.Image");
            btnCreateAss.ImageAlign = ContentAlignment.MiddleLeft;
            btnCreateAss.Location = new Point(951, 16);
            btnCreateAss.Margin = new Padding(3, 4, 3, 4);
            btnCreateAss.Name = "btnCreateAss";
            btnCreateAss.Padding = new Padding(6, 0, 6, 0);
            btnCreateAss.Size = new Size(169, 54);
            btnCreateAss.TabIndex = 29;
            btnCreateAss.Text = "Tạo mới";
            btnCreateAss.TextAlign = ContentAlignment.MiddleRight;
            btnCreateAss.UseVisualStyleBackColor = true;
            btnCreateAss.Click += btnCreateAss_Click;
            // 
            // label1
            // 
            ...
            btnCalendarWork.Location = new Point(699, 16);
            ...
            Controls.Add(btnCreateAss);
            Controls.Add(label1);
            FormBorderStyle = FormBorderStyle.None;
            Name = "AssisstantDescriptionDetail";
            Text = "AssisstantDescriptionDetail";
            Load += AssisstantDescriptionDetail_Load;
